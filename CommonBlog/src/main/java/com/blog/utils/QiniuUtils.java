...
public class QiniuUtils {
    ...
    public static  final String url = "rxdaxdail.hb-bkt.clouddn.com";

    @Value("Zh8CnH_NltCrBmeyjDHsd5MzFd4fVTP3H0VPdArK")
    private  String accessKey;
    @Value("QBu40jKvluC_eJf6DndeROLm1vdk6sTWXaUiSg0h")
